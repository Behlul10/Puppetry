...
#Face landmarker option for MP 
options = FaceLandmarkerOptions(
    base_options=BaseOptions(model_asset_path=model_path),
    running_mode=VisionRunningMode.LIVE_STREAM,
    output_face_blendshapes=True,                   #bool for Blendshapes needed for facial Animations
    output_facial_transformation_matrixes=True,     #3D space data on where the face is in the world
    num_faces=1,
    result_callback=print_result,
)

def run_detector():
    """Runs the MediaPipe face landmark detection."""
